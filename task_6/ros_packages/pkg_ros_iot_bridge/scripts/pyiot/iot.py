...
def mqtt_publish(arg_broker_url, arg_broker_port, arg_mqtt_topic, arg_pkg_dit, arg_mqtt_qos):
    ...
    try: 
        ...
        URL1 =   "https://script.google.com/macros/s/AKfycbwpEwzQnWlvi4LL0C1G3L-2FsrU81-ER1BnNn8eD_hXAJGeX-n9k5tq/exec"
                 
			#https://docs.google.com/spreadsheets/d/1e5kdWTpRGpYrf_LlEzxKefqHUVVYlShIKOXmnn1_hMc/edit#gid=0
        #URL1_ims3 = "https://script.google.com/macros/s/AKfycbww2Z8t1kH0UnckZBEIvy7oV2uebvSgwGKySG3fLhyrAzd4YM1GqYJr/exec"
        #URL1_unstructor = "https://script.google.com/macros/s/AKfycbw5xylppoda-8HPjt2Tzq4ShU_Xef-Ik-hEtBPcPk0gdGw8095j4RZ7/exec"
       ...
       # arg_mqtt_topic='/ros_iot_bridge/mqtt/sub'       
        ...
        print("1111111")
        #response = requests.get(URL1_ims3, params=arg_pkg_dit)
